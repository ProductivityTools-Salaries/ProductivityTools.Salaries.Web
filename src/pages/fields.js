export const fields = [
    ...
    { Label: "Total", Type: "number", Name: "total", field: "total", readonly: false, filtered: false, width: '250px' },
    ...
    { Label: "CreationDate", Type: "date", Name: "creationDate", field: "creationDate", readonly: false, filtered: false, width: '130px' },
